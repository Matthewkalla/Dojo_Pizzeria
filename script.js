...
function randomPizza() {
    ...
    if (Math.floor(Math.random() * 2) == 0) {
        ...
        var genSauce2 = randomSauce();
        if (genSauce2 != genSauce){
            genSauce.push(genSauce2);
        }
    }
    ...
    if (Math.floor(Math.random() * 2) == 0) {
        var genCheese2 = randomCheese();
        if (genCheese2 != genCheese) {
            genCheese.push(genCheese2);
        }
    }
